...
!
! References:
! [1] Baù G., Bombardelli, C., PelÃ¡ez, J., and Lorenzini, E., "Nonsingular
...
! MODULES
use SETTINGS,      only: eqs,insgrav,isun,imoon
...
! Evaluate time and spatial derivatives
dUdr = PACC_EJ2K(insgrav,0,0,0,0,rV,rmag,t,gradU_sph)
...
! Initializations
p = 0._dk; f = 0._dk
p = PACC_EJ2K(0,isun,imoon,0,0,rV,rmag,t)
p = INERT2ORB_EDROMO(p,z,cnu,snu)

! ==============================================================================
! 09. COMPUTE AUXILIARY QUANTITIES (2)
! ==============================================================================
