...
!fit2000
  REAL,PARAMETER,DIMENSION(SIZE(Z)):: LOGP = (/               &
 ...
 REAL,PARAMETER,DIMENSION(SIZE(Z)):: LOGRHO = (/             &
 ...
 -31.114578, -32.108589, -33.268623 /)
  ...
  REAL,PARAMETER,DIMENSION(SIZE(Z)):: DLOGPDZ = (/            &
  ...
  REAL,PARAMETER,DIMENSION(SIZE(Z)):: DLOGRHODZ = (/          & 
